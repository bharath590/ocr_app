...
class Upload extends Component {
    ...
    async handleSubmit(event) {
        ...
        this.setState({ confirmation: "Uploading..." });
            let url = "https://12zhbvvlhk.execute-api.us-east-1.amazonaws.com/prod";
         ...
         const response = await fetch(url,
            ...
            if(response){
                ...
                this.setState({ confirmation: "upload failed" })
            }
    }
    ...
    async getFiles(files) {
        ...
        let url = 'https://zgyes7gc8i.execute-api.us-east-1.amazonaws.com/prod';
        await fetch(url,
            {
            method: "POST",
            headers: {
        ...
        try {
            const posturl = "https://zgyes7gc8i.execute-api.us-east-1.amazonaws.com/prod/ocr";
            ...
            // this.setState({ Invoice: "22343ff" })
            // this.setState({ InvoiceDate: 10/20/22 })
